...
#define TIM2_IER   sfr(0x5301)
#define TIM2_SR1   sfr(0x5302)
...
#define TIM3_CR1   sfr(0x5320)
#define TIM3_IER   sfr(0x5321)
#define TIM3_SR1   sfr(0x5322)
#define TIM3_EGR   sfr(0x5324)
#define TIM3_CCMR1 sfr(0x5325)
#define TIM3_CCMR2 sfr(0x5326)
#define TIM3_CCER1 sfr(0x5327)
#define TIM3_PSCR  sfr(0x532a)
#define TIM3_ARRH  sfr(0x532b)
#define TIM3_ARRL  sfr(0x532c)

#define CFG_GCR sfr(0x7f60)

#define NESTED_IRQ(n) (sfr(0x7f70 + (n) / 4) &= ~(3 << ((n) % 4 * 2))) // Level 2 priority
